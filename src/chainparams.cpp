...
// Copyright (c) 2014-2018 The TRUSTplus Core developers
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 2 * 60; // TRUSTplus: every blocks
        consensus.nPowTargetSpacing = 1 * 60; // TRUSTplus: 60 seconds
        ...
        genesis = CreateGenesisBlock(1545787407, 3262185, 0x1e0ffff0, 1, 50 * COIN);
...
*/
	...
	vSeeds.push_back(CDNSSeedData("seed8", "miner2.trustplus.com"));
        ...
        // TRUSTplus BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // TRUSTplus BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // TRUSTplus BIP44 coin type is '5'
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("000007cab721086cb342ef169e3611e1931efc8b618df39ddc3e7082468f7080")),
            1545787407, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 60 * 60; // TRUSTplus: 1 hour
        consensus.nPowTargetSpacing = 2 * 60; // TRUSTplus: 2 minutes
   ...
   //     assert(genesis.hashMerkleRoot == uint256S("0x33a98e8f8089165dc24358b01d52dd740011bdbffad052d51d3ac3588af2f487"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,33);
        // Testnet TRUSTplus BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet TRUSTplus BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet TRUSTplus BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams() {
        ...
        // Regtest TRUSTplus addresses start with 'n'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,112);
        // Regtest TRUSTplus script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,10);
        // Regtest private keys start with '5' or 'c' (Bitcoin defaults) (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,240);
        // Regtest TRUSTplus BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest TRUSTplus BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Regtest TRUSTplus BIP44 coin type is '1' (All coin's testnet default)
        base58Prefixes[EXT_COIN_TYPE]  = boost::assign::list_of(0x80)(0x00)(0x00)(0x01).convert_to_container<std::vector<unsigned char> >();
   }
};
