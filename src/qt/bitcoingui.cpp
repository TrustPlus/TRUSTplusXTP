    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("TRUSTplus Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TRUSTplus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and trustplus: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About TRUSTplus Core"), this);
    aboutAction->setStatusTip(tr("Show information about TRUSTplus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TRUSTplus Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TRUSTplus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TRUSTplus addresses"));
    ...
    openAction->setStatusTip(tr("Open a trustplus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TRUSTplus Core help message to get a list with possible TRUSTplus Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("TRUSTplus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TRUSTplus network", "", count));
}
...
{
    QString strTitle = tr("TRUSTplus Core"); // default title
    ...
    // Append title to "TRUSTplus Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
