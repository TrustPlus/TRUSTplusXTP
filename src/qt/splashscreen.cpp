    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("TRUSTplus Core");
    ...
    QString copyrightTextTRUSTplus   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The TRUSTplus Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextTRUSTplus);
