...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("TRUSTplus Core trustplus-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  trustplus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded trustplus transaction") + "\n" +
              "  trustplus-tx [options] -create [commands]   " + _("Create hex-encoded trustplus transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded trustplus transaction
