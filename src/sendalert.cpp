...
2. run trustplusd with -printalert or -sendalert like this:
   /path/to/trustplusd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://trustpluscoin.io";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/TRUSTplus Core:0.12.0.58/"));
