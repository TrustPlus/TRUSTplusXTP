...
{
    if(fLiteMode) return; // ignore all TRUSTplus related functionality
...
/*
    ...
    allow endless transaction that would bloat TRUSTplus and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("trustplus-privatesend");
