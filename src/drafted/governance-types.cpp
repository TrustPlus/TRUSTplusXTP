...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "TRUSTplusNetwork") type = TRUSTplusNetwork;
    if(strType == "TRUSTplusNetworkVariable") type = TRUSTplusNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == TRUSTplusNetwork) s = "TRUSTplusNetwork";
    if(type == TRUSTplusNetworkVariable) s = "TRUSTplusNetworkVariable";
