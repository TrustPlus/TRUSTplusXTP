...
Only requiring some minor changes is trustplus.cpp.
...
Changes to trustplus.cpp
----------------------
trustplus.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
