...
This document provides guidelines for internationalization of the TRUSTplus Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to TRUSTplus network</numerusform>
            <numerusform>%n active connections to TRUSTplus network</numerusform>
        </translation>
    </message>
