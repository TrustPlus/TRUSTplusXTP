...
This mechanism has been integrated into Bitcore-Node-TRUSTplus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/trustpluscoin/insight-api-trustplus#web-socket-api](https://github.com/trustpluscoin/insight-api-trustplus#web-socket-api) 
* API: [https://github.com/trustpluscoin/insight-api-trustplus#instantsend-transactions](https://github.com/trustpluscoin/insight-api-trustplus#instantsend-transactions) 
...
By default, the TRUSTplus Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TRUSTplus Core daemon:
