...
TRUSTplus Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as TRUSTplus Core, where everyone uses
...
pay attention to for reviewers of TRUSTplus Core code.

General TRUSTplus Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: TRUSTplus Core uses tinyformat, which is type safe. Leave them out to avoid confusion
